...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_services_auth_service__WEBPACK_IMPORTED_MODULE_13__["AuthService"], _guards_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]],
...
module.exports = "<div class=\"jumbotron\">\n  <h1 class=\"display-4\">UCSC Lab Reservation</h1>\n  <p class=\"lead\">Login or register to start reserving your slot in our labs</p>\n  <hr class=\"my-4\">\n  <div>\n    <a class=\"btn btn-primary\" routerLink=\"/login\" role=\"button\">Login</a>\n    <a class=\"btn btn-default\" routerLink=\"/register\">Register</a>\n  </div>\n</div>\n\n<div class=\"row text-center\">\n  <div class=\"col-md-4\">\n    <h3>Express Backend</h3>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>Angular 6 Frontend</h3>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>JWT Tokens</h3>\n  </div>\n</div>\n\n"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(fb, auth, routes, flashMessage) {
        this.fb = fb;
        this.auth = auth;
        this.routes = routes;
    ...
    LoginComponent.prototype.loginUser = function (value) {
        ...
        this.auth.loginUser(user).subscribe(function (res) {
            if (res['success']) {
                _this.auth.storeUserData(res['token'], res['user']);
                _this.flashMessage.show("You've successfully logged in", { cssClass: 'alert-success', timeout: 5000 });
                _this.routes.navigateByUrl('dashboard');
            }
            else {
                _this.flashMessage.show(res['msg'], { cssClass: 'alert-danger', timeout: 5000 });
            }
        });
    };
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], angular2_flash_messages__WEBPACK_IMPORTED_MODULE_4__["FlashMessagesService"]])
    ], LoginComponent);
...
module.exports = "<nav class=\"navbar navbar-expand-md navbar-dark bg-dark\">\n  <a class=\"navbar-brand\" routerLink=\"/\">Auth App</a>\n  <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarsExampleDefault\" aria-controls=\"navbarsExampleDefault\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n    <span class=\"navbar-toggler-icon\"></span>\n  </button>\n\n  <div class=\"collapse navbar-collapse\" id=\"navbarsExampleDefault\">\n    <ul class=\"navbar-nav mr-auto\">\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" routerLink=\"/\" [routerLinkActiveOptions]=\"{exact:true}\" routerLinkActive=\"active\">Home</a>\n      </li>\n    </ul>\n    <ul class=\"navbar-nav my-2 my-lg-0\">\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" routerLink=\"/login\" routerLinkActive=\"active\" [hidden]=\"user\">Login</a>\n      </li>\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" routerLink=\"/register\" routerLinkActive=\"active\" [hidden]=\"user\">Register</a>\n      </li>\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" href=\"#\" routerLink=\"/dashboard\" [hidden]=\"!user\">Dashboard</a>\n      </li>\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" href=\"#\" routerLink=\"/profile\" [hidden]=\"!user\">Profile</a>\n      </li>\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" href=\"#\" (click)=\"onLogoutClick()\" [hidden]=\"!user\">Logout</a>\n      </li>\n    </ul>\n  </div>\n</nav>"
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(auth, flashmessage, routes) {
        this.auth = auth;
        this.flashmessage = flashmessage;
        this.routes = routes;
    }
    NavbarComponent.prototype.ngOnInit = function () {
        ...
        this.auth.userVisibilityChange.subscribe(function (value) {
...
module.exports = "<h3>{{user.name}}</h3>\n<h4>{{user.username}}</h4>\n<h4>{{user.email}}</h4>\n"
...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.user = this.auth.getProfile().subscribe(function (res) {
            _this.user = res['user'];
        });
    };
...
module.exports = "<div class=\"alert alert-danger\" role=\"alert\" [hidden]=\"!message\">\n  {{message}}\n</div>\n\n<div style=\"padding-top: 50px;\">\n  <form (ngSubmit)=\"onRegisterSubmit(registerForm.value)\" [formGroup]=\"registerForm\">\n    <div class=\"form-group\">\n      <label for=\"exampleInputEmail1\">Name</label>\n      <input type=\"text\" class=\"form-control\" placeholder=\"Enter Name\" formControlName=\"name\">\n      <div *ngIf=\"!registerForm.controls['name'].valid && (registerForm.controls['name'].dirty || registerForm.controls['name'].touched)\" class=\"alert alert-danger\">\n        Name is invalid\n      </div>\n    </div>\n    <div class=\"form-group\">\n      <label for=\"exampleInputEmail1\">Username</label>\n      <input type=\"text\" class=\"form-control\" placeholder=\"Enter Username\" formControlName=\"username\">\n      <div *ngIf=\"!registerForm.controls['username'].valid && (registerForm.controls['username'].dirty || registerForm.controls['username'].touched)\" class=\"alert alert-danger\">\n        Username must have atleast 3 characters\n      </div>\n    </div>\n    <div class=\"form-group\">\n      <label for=\"exampleInputEmail1\">Email</label>\n      <input type=\"email\" class=\"form-control\" placeholder=\"Enter Email\" formControlName=\"email\">\n      <small id=\"emailHelp\" class=\"form-text text-muted\">We'll never share your email with anyone else.</small>\n      <div *ngIf=\"!registerForm.controls['email'].valid && (registerForm.controls['email'].dirty || registerForm.controls['email'].touched)\" class=\"alert alert-danger\">\n        Email is not valid\n      </div>\n    </div>\n    <div class=\"form-group\">\n      <label for=\"exampleInputPassword1\">Password</label>\n      <input type=\"password\" class=\"form-control\" id=\"exampleInputPassword1\" placeholder=\"Password\" formControlName=\"password\">\n      <div *ngIf=\"!registerForm.controls['password'].valid && (registerForm.controls['password'].dirty || registerForm.controls['password'].touched)\" class=\"alert alert-danger\">\n        Password must be atleast 6 characters long\n      </div>\n    </div>\n    <button type=\"submit\" class=\"btn btn-primary\" [disabled]=\"!registerForm.valid\">Submit</button>\n  </form>\n</div>"
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(fb, auth, routes, flashMessage) {
        this.fb = fb;
        this.auth = auth;
        this.routes = routes;
        this.flashMessage = flashMessage;
        this.registerForm = fb.group({
            ...
            'username': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].minLength(3)])],
    ...
    RegisterComponent.prototype.onRegisterSubmit = function (value) {
        ...
        this.auth.registerUser(user).then(function (res) {
            if (res['success']) {
                _this.flashMessage.show('You have been successfully registered', { cssClass: 'alert-success', timeout: 5000 });
                _this.routes.navigateByUrl('login');
            }
            else {
                _this.flashMessage.show('A problem has occured!', { cssClass: 'alert-danger', timeout: 5000 });
            }
        });
    };
...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(auth, routes) {
        this.auth = auth;
        this.routes = routes;
    }
...
var AuthService = /** @class */ (function () {
    function AuthService(http) {
        var _this = this;
        this.http = http;
        this.userVisibilityChange = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        ...
        this.userVisibilityChange.subscribe(function (value) {
            // console.log('received new value : ', value);
            _this.userExist = value;
        });
    }
    Object.defineProperty(AuthService.prototype, "userAvailable", {
        get: function () {
...
module.exports = __webpack_require__(/*! /Users/tuanamith/Projects/lab-reserve-node/angular-src/src/main.ts */"./src/main.ts");
